                ...
                <form action="{{ route('admin.announcements.store') }}" method="POST" class="p-8">
                    ...
                    <div class="flex justify-between mt-6">
                        <a href="{{ route('admin.announcements.index') }}"
                            class="inline-flex items-center gap-2 bg-red-500 text-white font-bold px-8 py-3 rounded-lg hover:bg-gray-400 transition-all duration-200 shadow-lg hover:shadow-xl">
                        ...
                        <button type="submit"
                            class="inline-flex items-center gap-2 bg-[#31694E] text-white font-bold px-8 py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
