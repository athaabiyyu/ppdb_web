        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8 sm:mb-12">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <h1 class="text-2xl sm:text-4xl font-bold text-[#31694E]">Tambah Pengumuman Baru</h1>
                </div>
                <p class="text-sm sm:text-base text-gray-600 ml-4">Buat dan publikasikan pengumuman penting untuk pendaftar</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                {{-- Form Body --}}
                <form action="{{ route('admin.announcements.store') }}" method="POST" class="p-4 sm:p-8">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <textarea
                            ...
                            placeholder="Ringkasan maksimal 500 karakter - ini akan ditampilkan di daftar pengumuman" required>{{ old('description') }}</textarea>
                    ...
                    <div class="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 sm:gap-4 mt-6">
                        ...
                        <button type="submit"
                            class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#31694E] hover:bg-[#25523e] text-white font-bold px-6 sm:px-8 py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl text-sm sm:text-base">
                            <svg class="w-4 sm:w-5 h-4 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
